          ...
          <motion.div className="space-y-2">
            <p className="flex items-start">
              ...
              <span className="ml-2">Send your lecture notes or past exam questions to <span className="lowercase text-[#67e8bc]">documents@afroai.ai</span>&nbsp;
                                     Name your lecture notes like this: Course_University_Level ( <span className=" text-[#67e8bc]">Anatomy401_UniversityOfJos_400level</span> ).</span>
            </p>
            <p className="flex items-start">
              <span>2.</span>
              <span className="ml-2">We run a check on the uploaded lecture note making sure it's clear, readable and doesn't contain profanity.
                                     If it passes our quality check, we go ahead to upload it to our AI database where<span className=" text-[#67e8bc]">Wise Nurse</span> 
                                     can interact with your lecture notes.</span>
            </p>
            <p className="flex items-start">
              <span>3.</span>
              <span className="ml-2"> We'll send you an email notifying you when to begin using <span className=" text-[#67e8bc]">Wise Nurse</span> to study, 
